...
class KSPRTrimester23Activity : AppCompatActivity() {
    private lateinit var textViewScore: TextView
    private lateinit var simpanButton: Button
    private val urlFinal = "https://18319028tugasakhir.com/isiselanjutnya.php"
    ...
    private fun saveScore() {
        ...
        val sharedPref = getSharedPreferences("PREFS_TRIMESTER2", Context.MODE_PRIVATE)
        val beratBadanValue = sharedPref.getString("BeratBadan", "")
        val trimesterValue = sharedPref.getString("Trimester", "")
        ...
        paramsFinal["Trimester"] = trimesterValue.toString()
        paramsFinal["Idbidan"] = Idbidan
        paramsFinal["Idpasien"] = idPasien2
        ...
        paramsNew["Idpasien"] = idPasien2
        paramsNew["Trimester"] = trimesterValue.toString()
        ...
        val jsonObjectRequestFinal = JsonObjectRequest(
            ...
            Response.Listener { response ->
                ...
                val intent = Intent().apply {
                    putExtra(EXTRA_ID_PASIEN, idPasien2)
                }
