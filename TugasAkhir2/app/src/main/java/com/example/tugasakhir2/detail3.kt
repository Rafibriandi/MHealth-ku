...
import com.example.tugasakhir2.databinding.Pengukuranpasiendetail2Binding
...
class Detail3Activity : AppCompatActivity() {
    ...
    private lateinit var binding: Pengukuranpasiendetail2Binding
    var b: Bundle? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = Pengukuranpasiendetail2Binding.inflate(layoutInflater)
