...
class EdukasiAdapterBidan(private val context: Context) : RecyclerView.Adapter<EdukasiAdapterBidan.EdukasiViewHolder>() {
    ...
    fun loadFromAPI2() {
        val url = "https://18319028tugasakhir.com/getmateriedukasibidan.php"
